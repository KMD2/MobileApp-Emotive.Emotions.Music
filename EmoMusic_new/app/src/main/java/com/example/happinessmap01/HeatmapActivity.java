    ...
    private class HeatmapDatasetGet extends AsyncTask {
        ...
        protected Object doInBackground(Object... urls) {
            try {
                ...
                String response2 = downloadUrl(((String) urls[0]) + "/EPOCPLUS-3b9ae818");
                map.put(getString(R.string.my_map), response1);
                map.put(getString(R.string.common_map), response2);
