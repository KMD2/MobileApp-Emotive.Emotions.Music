...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t.scheduleAtFixedRate(
                new TimerTask()
                {
                    public void run()
                    {
                        ...
                        task.execute("ec2-52-14-214-97.us-east-2.compute.amazonaws.com:3300/api/performance/EPOCPLUS-3b9ae818");

                        Log.v("performance","Dude are you in " + getString(R.string.performance_query));
                    }
                },
        ...
        /*if (connectivityManager.getActiveNetworkInfo() != null && connectivityManager.getActiveNetworkInfo().isConnected())
            Log.v("Network_Check","Whatever");
        else
            Log.v("Network_check2","Whatever2");*/
    ...
    private class GetMeasurments extends AsyncTask {
        ...
        protected Object doInBackground(Object... urls) {
            try {
                ...
                e.printStackTrace();
                Log.v("app network", e.getMessage() );
        ...
        protected void onPostExecute(Object result) {
            try{
                ...
                Log.d("app json parsing",  e.getMessage());
            }
        }
    ...
    private class DatabaseUpdate extends AsyncTask {
        ...
        private String downloadUrl(String _url) throws IOException {
            ...
            try {
                ...
                String endDate = DateTypeConverter.toString(cal.getTime());
                cal.add(Calendar.MONTH, -1);
                String beginDate = DateTypeConverter.toString(cal.getTime());
        ...
        private List<Emos> parseJson(JSONArray items) throws JSONException {
            ...
            for (int i = 0; i < items.length(); i++) {
                ...
                String recoDate = item.getString("recorded_time");
